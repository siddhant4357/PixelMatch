...
const Guest = () => {
  ...
  const searchTips = [
    ...
    "✨ Analyzing facial features with advanced AI...",
  ...
  return (
    <div className="min-h-screen">
      ...
      {searching && (
        <LoadingSpinner
          message="Searching for Your Photos"
          tips={searchTips}
          fullScreen={true}
        />
      )}
      ...
      <div className="container mx-auto px-6 py-12 max-w-6xl">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold mb-4 bg-gradient-to-r from-purple-600 via-pink-600 to-purple-600 bg-clip-text text-transparent">Find My Photos</h1>
          <p className="text-xl text-slate-600 mb-6">Upload your selfie to find all photos you appear in</p>

          <Link
            to="/guest/ask-ai"
            className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-purple-400 to-pink-400 text-white rounded-xl font-semibold hover:scale-105 transition-all shadow-lg"
          >
        ...
        <div className="bg-white/60 backdrop-blur-md border border-purple-200/50 rounded-2xl p-8 mb-8 shadow-lg">
          <h2 className="text-2xl font-bold mb-6 bg-gradient-to-r from-purple-600 to-pink-600 bg-clip-text text-transparent">Upload Your Selfie</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <div>
              <label className="flex items-center space-x-2 text-slate-800 font-semibold mb-2">
              ...
              <input
                ...
                className="w-full"
              />
              <div className="text-center text-slate-600 text-sm mt-1">
            ...
            <div>
              <label className="text-slate-800 font-semibold mb-2 block">Max Results</label>
              <input
                type="number"
                min="10"
                max="100"
                ...
                className="w-full px-4 py-2 bg-white/50 border border-purple-200 rounded-xl text-slate-700 focus:border-purple-400 focus:outline-none focus:ring-2 focus:ring-purple-400"
              />
            </div>
          </div>
          ...
          <div>
            {results.total_matches === 0 ? (
              ...
              <>
                ...
                <h3 className="text-2xl font-bold mb-6 text-slate-800">Top Matches</h3>
                  ...
                  <>
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 opacity-80 hover:opacity-100 transition-opacity">
                      {results.matches.filter(m => m.max_similarity < 0.50).map((match, index) => (
                        <div
                          key={`low-${index}`}
                          className="bg-white/40 backdrop-blur-sm border border-purple-200/30 rounded-xl overflow-hidden hover:border-orange-400/50 transition-all group shadow-md"
                        >
                          <img
                            src={getPhotoUrl(match.photo_name)}
                            alt={match.photo_name}
                          ...
                          />
                          <div className="p-4">
                            <div className="text-slate-700 font-medium text-sm mb-2 truncate">
                              {match.photo_name}
                            </div>
                            <div className="flex items-center justify-between mb-3">
                            ...
                            <a
                              href={getPhotoUrl(match.photo_name)}
                              download
                              className="w-full px-4 py-2 bg-slate-600 hover:bg-slate-500 text-white rounded-lg text-sm font-semibold transition-all flex items-center justify-center space-x-2"
                            >
                              <Download className="w-4 h-4" />
                              <span>Download</span>
                            </a>
